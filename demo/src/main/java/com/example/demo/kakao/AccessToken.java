...
public class AccessToken {
	...
	public AccessToken(String token_type, String access_token, Integer expires_in, String refresh_token,
	...
	public String toString() {
		return "AccessToken [token_type=" + token_type + ", access_token=" + access_token + ", expires_in=" + expires_in
